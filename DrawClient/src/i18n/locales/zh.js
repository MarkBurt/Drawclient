...
const zh = {
  translation: {
    ...
    contact_author_subtitle: "通过以下任何渠道与 DrawClient 团队取得联系：",
    contact_github_desc: "报告问题、贡献代码或查看源代码 / https://gitee.com/xuanqings/drawclient",
    contact_twitter_desc: "关注获取更新和公告",
    contact_discord_desc: "加入我们的社区进行讨论",
    contact_docs_desc: "阅读指南和 API 文档",
    contact_tip_title: "小贴士",
    contact_tip_desc: "对于错误报告和功能请求，GitHub/GitEE Issues 是获得快速响应的最佳地方。",
    documentation: "文档",
    feedback: "反馈",
    no_changes: "没有更改",
    loading: "加载中...",
